# Generated by Django 5.0.7 on 2025-02-03 08:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'admin'), ('driver', 'driver'), ('executive', 'executive')], default='admin', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invited_users', models.ManyToManyField(blank=True, related_name='meeting_invites', to=settings.AUTH_USER_MODEL)),
                ('requester_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requested_meetings', to=settings.AUTH_USER_MODEL)),
                ...
                ('purpose', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='bookingsystem.purpose')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('resource_type', models.CharField(choices=[('Room', 'Room'), ('Vehicle', 'Vehicle'), ('Executive Meeting', 'Executive Meeting')], max_length=50)),
